<div x-show="open" x-cloak @keydown.escape.window="open = false"
    ...
    <form method="POST" action="{{ route('exams.store') }}" x-show="open"
        ...
        x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" class="relative w-full max-w-md
               rounded-2xl
        ...
        <div class="space-y-4">
            ...
            <div>
                <label class="block mb-1 text-sm font-medium
                            text-ens-darkest dark:text-ens-light">
                    Tipe Tes
                </label>

                <select name="test_type" required class="w-full rounded-xl
            ...
            <div>
                ...
                <input name="title" required class="w-full rounded-xl
                           border-gray-300 dark:border-gray-700
                           bg-white dark:bg-ens-darkest
                           px-3 py-2 text-sm
                           text-ens-darkest dark:text-ens-lighter
            ...
            <div>
                ...
                <input type="datetime-local" name="exam_date" required class="w-full rounded-xl
                           border-gray-300 dark:border-gray-700
                           bg-white dark:bg-ens-darkest
                           px-3 py-2 text-sm
                           text-ens-darkest dark:text-ens-lighter
        ...
        <div class="mt-6 flex justify-end gap-2">
            ...
            <button type="button" @click="open = false" class="px-4 py-2 rounded-xl
                       text-sm font-medium
                       text-gray-600 dark:text-gray-300
                       border border-gray-300 dark:border-gray-600
                       hover:bg-gray-100 dark:hover:bg-ens-darkest
                       transition">
                Batal
            </button>
