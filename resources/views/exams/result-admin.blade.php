            ...
            <tbody class="divide-y divide-gray-200 dark:divide-white/10">
                @forelse($attempts as $i => $attempt)
                    <tr class="block md:table-row py-4 md:py-0">
                        ...
                        {{-- NILAI DESKTOP --}}
                        <td class="hidden md:table-cell pr-6 font-semibold text-primary dark:text-gray-400">
                            {{ $attempt->score }}
                        </td>

                        {{-- DURASI DESKTOP --}}
                        <td class="hidden md:table-cell text-primary dark:text-gray-200">
