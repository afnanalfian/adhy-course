...
@section('content')
    <div class="min-h-screen">
        ...
        <div class="max-w-3xl mx-auto">
            {{-- Tombol Kembali --}}
            <div class="mb-4">
                <a href="{{ route('siswa.index') }}" class="inline-flex items-center gap-2
                          text-sm font-medium
            ...
            <div class="bg-ens-lightest dark:bg-ens-darker
                ...
                <div class="grid sm:grid-cols-2 gap-4 text-sm">
                    <div class="rounded-xl bg-white dark:bg-ens-darkest/50
                               px-4 py-3">
                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-3">
                    ...
                    {{-- WhatsApp --}}
                    <a href="https://wa.me/{{ $user->whatsapp_phone }}" target="_blank" class="inline-flex items-center justify-center gap-2
                    ...
                    {{-- Toggle Active --}}
                    <form method="POST" action="{{ route('siswa.toggle', $user->id) }}" class="sweet-confirm" data-message="{{ $user->is_active
