...
@section('content')
    <div class="max-w-7xl mx-auto px-4 py-4 space-y-6 overflow-x-hidden">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <span
                class="self-start sm:self-auto px-4 py-2 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-300 rounded-lg text-sm font-medium">
                {{ now()->format('d M Y') }}
            </span>
        </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            @endphp
            @foreach($cards as $c)
                <div class="rounded-xl p-4 border bg-ens-lighter dark:bg-gray-800 dark:border-gray-700">
        ...
        {{-- MY COURSES --}}
        <div class="bg-ens-lightest dark:bg-gray-800 rounded-2xl p-4 border dark:border-gray-700">
