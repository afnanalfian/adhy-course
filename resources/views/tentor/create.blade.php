...
@section('content')
    ...
    <div class="px-4 py-8 max-w-2xl mx-auto">
        ...
        <h1 class="text-2xl font-bold mb-6 text-ens-darkest dark:text-ens-lighter">
            Tambah Tentor
        </h1>
        ...
        <div class="bg-ens-lightest dark:bg-ens-darker border border-gray-200 dark:border-ens-darkest
            ...
            <form method="POST" action="{{ route('tentor.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="user_id" class="w-full mt-1 p-3 rounded-xl border
                               bg-white dark:bg-ens-darkest border-gray-300 dark:border-gray-700
                ...
                <div>
                    ...
                    <select name="course_id[]" id="course-select" multiple class="w-full mt-1 p-3 rounded-xl border
                               bg-white dark:bg-ens-darkest border-gray-300 dark:border-gray-700
                ...
                <div>
                    ...
                    <textarea name="bio" rows="4" class="w-full mt-1 p-3 rounded-xl border
                               bg-white dark:bg-ens-darkest border-gray-300 dark:border-gray-700
                               text-gray-800 dark:text-gray-200
                ...
                {{-- Submit --}}
                <button class="px-5 py-3 bg-primary text-white rounded-xl font-medium
