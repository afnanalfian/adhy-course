...
@section('content')
    ...
    <div class="min-h-screen">
        ...
        <div class="max-w-2xl mx-auto">
            ...
            {{-- Back --}}
            <div class="mb-5">
                <a href="{{ route('tentor.show', $teacher->id) }}" class="inline-flex items-center gap-2 text-sm font-medium
                          text-ens-darker dark:text-ens-lighter hover:text-primary">
            ...
            <div class="bg-ens-lightest dark:bg-ens-darker/80 border border-gray-200 dark:border-ens-darkest/50
                ...
                <form method="POST" action="{{ route('tentor.update', $teacher->id) }}" class="space-y-5">
                    ...
                    {{-- Bio --}}
                    <div>
                        <label class="font-semibold text-sm dark:text-ens-lighter">Bio Tentor</label>
                        <textarea name="bio" rows="4" class="w-full mt-1 p-3 rounded-xl border bg-gray-50 dark:bg-ens-darkest/60
                    ...
                    {{-- Courses --}}
                    <div>
                        <label class="font-semibold text-sm  dark:text-ens-lighter">Mengajar Course</label>

                        <select name="course_id[]" multiple id="course-select" class="w-full mt-1 p-2 rounded-xl border
                                bg-gray-50 dark:bg-ens-darkest/60
    ...
    @push('styles')
        <style>
            ...
            html.dark .ts-control {
                background-color: rgba(2, 16, 36, 0.5) !important;
                /* dark glassy */
            ...
            html.dark .ts-dropdown .ts-option:hover {
                background-color: rgba(84, 131, 179, 0.25) !important;
                /* primary 25% */
            }
