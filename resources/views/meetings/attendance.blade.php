...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        FORM
        ====================== --}}
        <form method="POST" action="{{ route('meeting.attendance.store', $meeting) }}" class="space-y-4
            ...
            @forelse ($eligibleStudents as $i => $student)
                ...
                <div
                    class="flex items-center justify-between p-4 rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-secondary hover:bg-ens-lighter dark:hover:bg-ens-lightest/5 transition md:grid md:grid-cols-12 md:gap-4">
                    {{-- NO (DESKTOP) --}}
            ...
            <div class="flex flex-col sm:flex-row
                ...
                <a href="{{ route('meeting.show', $meeting) }}" class="px-4 py-2 rounded-lg
                          text-center
                          text-gray-600 dark:text-gray-300
                          hover:bg-ens-lighter dark:hover:bg-ens-lightest/5">
                    Kembali
                </a>
