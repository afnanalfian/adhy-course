...
<div class="max-w-7xl mx-auto space-y-6 p-4">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl md:text-3xl font-bold text-ens-darker dark:text-ens-lighter">
    ...
    @else
        <div class="bg-ens-lightest dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700 text-center">
            <div class="flex flex-col items-center justify-center">
