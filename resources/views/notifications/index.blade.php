    ...
    <div class="max-w-5xl mx-auto space-y-6 px-4 sm:px-0">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex gap-2">
                ...
                <form method="POST" action="{{ route('notifications.clear') }}" class="sweet-confirm"
        ...
        <div class="rounded-2xl overflow-hidden
                    ...
                    border dark:border-ens-darkest">

            @forelse($notifications as $notification)

                <div class="flex gap-4 p-4
                                border-b last:border-b-0
                                dark:border-ens-darkest
                ...
                : '' }}">
                    ...
                    <div class="flex-1 min-w-0">
                        <a href="{{ $notification->data['url'] ?? '#' }}" data-notif-id="{{ $notification->id }}" class="notif-link block font-medium
