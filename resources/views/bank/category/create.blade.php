...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 sm:p-8 max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Tambah Kategori Bank Soal</h1>
        ...
        <form action="{{ route('bank.category.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
