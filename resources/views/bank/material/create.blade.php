...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 sm:p-8 max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-1">Tambah Materi</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Kategori: <span class="font-medium text-gray-700 dark:text-gray-300">{{ $category->name }}</span></p>
        ...
        <form action="{{ route('bank.category.materials.store', $category) }}" method="POST" class="space-y-5">
            @csrf
