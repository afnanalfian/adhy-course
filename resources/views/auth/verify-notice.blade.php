        ...
        ">
            ...
            <div class="flex justify-center mb-6">
                <div class="
                    ...
                    bg-ens-light dark:bg-ens-darkest
                    flex items-center justify-center
                    shadow-inner dark:shadow-none
                    border border-ens-light/50 dark:border-ens-medium/20
                ">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-ens-darker dark:text-ens-lighter"
            ...
            <div class="mt-8 text-center">
                ...
                {{-- Countdown --}}
                <div id="countdown" class="text-sm text-gray-600 dark:text-gray-300 mb-3" @if ($remaining === 0)
                ...
                {{-- Resend Button --}}
                <form method="POST" action="{{ route('verification.send') }}" id="resend-form" @if ($remaining > 0)
                style="display:none" @endif>
                    @csrf
                    <button class="
                            w-full py-3 rounded-lg font-bold
                            text-white bg-primary hover:bg-ens-medium
                            dark:bg-ens-medium dark:hover:bg-primary
            ...
            <a href="{{ route('home') }}" class="
                    ...
                    text-primary dark:text-ens-light hover:underline
                ">
