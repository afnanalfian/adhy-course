    ...
    <div class="max-w-7xl mx-auto space-y-6 p-4">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2">
                <a href="?week={{ $weekOffset - 1 }}" class="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:text-ens-lightest
        ...
        {{-- ================= WEEKLY SALES ================= --}}
        <div class="bg-ens-lightest dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {{-- MEETINGS THIS WEEK --}}
            <div
                class="bg-ens-lightest dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <div
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span
                        class="px-3 py-1 bg-yellow-100 dark:bg-yellow-500/20 text-yellow-800 dark:text-yellow-300 text-sm font-medium rounded-full">
                        ...
                        <tbody>
                            @forelse($pendingOrders as $order)
                                <tr class="border-b border-gray-100 dark:border-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-700/30 cursor-pointer transition"
                                    ...
                                    <td class="py-3 px-4">
                                        <span
                                            class="px-3 py-1 bg-yellow-100 dark:bg-yellow-500/20 text-yellow-800 dark:text-yellow-300 text-xs font-medium rounded-full">
                                            PAID
                                        </span>
                                    </td>
                                    <td class="py-3 px-4">
