...
@section('content')
    <div class="min-h-screen">
        ...
        <div class="max-w-xl mx-auto">
            ...
            {{-- Danger Card --}}
            <div class="bg-white dark:bg-ens-darker
                ...
                <form method="POST" action="{{ route('profile.destroy') }}" x-data="{ other: false }"
                    ...
                    <div>
                        ...
                        {{-- Custom reason --}}
                        <input type="text" x-show="other" x-transition name="reason_custom"
                            placeholder="Tuliskan alasan Anda..." class="input-primary mt-3">
                    </div>
                    ...
                    {{-- Action --}}
                    <button type="submit" class="w-full py-3 rounded-xl bg-red-600 hover:bg-red-700
