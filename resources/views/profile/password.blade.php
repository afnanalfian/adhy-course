            ...
            <div class="bg-ens-lightest dark:bg-ens-darker
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm mt-1
                              text-ens-medium dark:text-ens-light">
                ...
                <form method="POST" action="{{ route('profile.password.update') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="password" name="current_password" class="input-primary"
                    ...
                    <div>
                        ...
                        <input type="password" name="password" class="input-primary" autocomplete="new-password">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" name="password_confirmation" class="input-primary"
