    ...
    <div class="max-w-7xl mx-auto space-y-6 px-4 sm:px-0">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <form method="GET" class="w-full sm:w-72">
                <input type="text" name="q" value="{{ $q }}" placeholder="Cari nama / email siswa..." class="w-full rounded-xl
        ...
        <div class="space-y-4">
            ...
            @forelse($users as $user)
                <div class="rounded-2xl p-5
                               bg-ens-lightest dark:bg-ens-darkest
                               border border-gray-200 dark:border-ens-darker">
                    ...
                    <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                        ...
                        @forelse($user->entitlements as $entitlement)
                                <div class="rounded-xl p-3
                                                   border border-gray-200 dark:border-ens-darker
                                                   bg-gray-50 dark:bg-ens-darker/50">
