    ...
    <div class="min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-ens-darkest rounded-xl border border-gray-200 dark:border-ens-medium
                ...
                <div class="px-6 py-4 bg-gradient-to-r from-blue-50 to-white dark:from-blue-900/10 dark:to-ens-darkest
                            border-b border-blue-100 dark:border-blue-500/20">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            <h2 class="font-bold text-lg text-ens-darkest dark:text-ens-lighter">
                        ...
                        <div class="flex items-center gap-3">
                            <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium
                                ...
                                <svg class="w-3 h-3 mr-1.5 animate-pulse" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {{-- Total Amount --}}
                        <div class="p-4 rounded-lg bg-gray-50 dark:bg-ens-darker">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-xl font-bold text-primary dark:text-ens-lighter">
                        ...
                        {{-- Deadline --}}
                        <div
                            class="p-4 rounded-lg bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-500/20">
                            <div class="flex items-center gap-3 mb-2">
                                <div
            ...
            <div class="bg-white dark:bg-ens-darkest rounded-xl border border-gray-200 dark:border-ens-medium
                ...
                <div class="px-6 py-4 bg-gradient-to-r from-green-50 to-white dark:from-green-900/10 dark:to-ens-darkest
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-green-600/80 dark:text-green-400/80">Scan QR Code untuk melakukan
                                pembayaran</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                        ...
                        <div class="flex flex-col items-center">
                            @if ($qrisImage)
                                <div
                                    class="mb-4 p-4 bg-white dark:bg-ens-darker rounded-xl border border-gray-200 dark:border-ens-medium shadow-sm">
                                    <img src="{{ asset('storage/' . $qrisImage) }}" alt="QRIS Code"
                                        class="max-w-[280px] rounded-lg" loading="lazy">
                                </div>
                                <div class="text-center">
                                    <p class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Scan QR Code</p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Gunakan aplikasi mobile banking atau
                                        e-wallet</p>
                                </div>
                            @else
                                <div
                                    class="w-full p-8 text-center border-2 border-dashed border-gray-300 dark:border-ens-medium rounded-xl">
                        ...
                        <div>
                            ...
                            <div class="bg-gradient-to-br from-emerald-50 to-white dark:from-emerald-900/10 dark:to-ens-darkest
                                        rounded-xl p-5 border border-emerald-200 dark:border-emerald-500/30">
                                <h3
                                    class="font-semibold text-emerald-800 dark:text-emerald-300 mb-3 flex items-center gap-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-white dark:bg-ens-darkest rounded-xl border border-gray-200 dark:border-ens-medium
                ...
                <div class="px-6 py-4 bg-gradient-to-r from-purple-50 to-white dark:from-purple-900/10 dark:to-ens-darkest
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-purple-600/80 dark:text-purple-400/80">Lengkapi semua syarat wajib untuk
                                mendapatkan akses</p>
                        </div>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('checkout.uploadProof', $order) }}" enctype="multipart/form-data"
                    ...
                    <div class="p-6 space-y-8">
                        {{-- Syarat 1 (Wajib) --}}
                        <div
                            class="bg-white dark:bg-ens-darker rounded-xl border-2 border-blue-200 dark:border-blue-500/30 p-5">
                            <div class="flex items-start justify-between mb-4">
                                ...
                                <span
                                    class="text-xs px-2 py-1 rounded-full bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 font-medium">
                                    Wajib
                                </span>
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="relative">
                                    <input type="file" name="proof_images[]" required accept="image/*,.pdf" class="w-full px-4 py-3 rounded-lg border-2 border-dashed border-gray-300 dark:border-ens-medium
                        ...
                        {{-- Syarat 2 (Wajib) --}}
                        <div
                            class="bg-white dark:bg-ens-darker rounded-xl border-2 border-green-200 dark:border-green-500/30 p-5">
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex items-start gap-3">
                                    <div
                                ...
                                <span
                                    class="text-xs px-2 py-1 rounded-full bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300 font-medium">
                                    Wajib
                                </span>
                            </div>
                        ...
                        {{-- Syarat 3 (Wajib) --}}
                        <div
                            class="bg-white dark:bg-ens-darker rounded-xl border-2 border-purple-200 dark:border-purple-500/30 p-5">
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex items-start gap-3">
                                    <div
                                ...
                                <span
                                    class="text-xs px-2 py-1 rounded-full bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300 font-medium">
                                    Wajib
                                </span>
                            </div>
                        ...
                        @error('proof_images')
                            <div
                                class="p-4 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-500/30">
                                <div class="flex items-center gap-2">
                                    <svg class="w-5 h-5 text-red-600 dark:text-red-400" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.794-.833-2.564 0L4.22 16.5c-.77.833.192 2.5 1.732 2.5z" />
                                    </svg>
                        ...
                        <div class="pt-6 border-t border-gray-200 dark:border-ens-medium">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                ...
                                <button type="submit" id="submit-btn" class="w-full sm:w-auto inline-flex items-center justify-center px-8 py-3.5 rounded-lg
                ...
                input.addEventListener('change', function () {
                    ...
                    if (file) {
                        ...
                        `;
                            ...
                            // Change border color
                            this.classList.remove('border-gray-300', 'dark:border-ens-medium');
            ...
            form.addEventListener('submit', function (e) {
                ...
                requiredInputs.forEach(input => {
                    if (!input.files || input.files.length === 0) {
                        ...
                        input.classList.remove('border-gray-300', 'dark:border-ens-medium', 'border-green-500', 'dark:border-green-500');
                    }
                });
