...
@section('content')
    <a href="{{ route('pricing.index') }}" class="text-sm font-medium text-primary hover:underline dark:text-ens-lightest">
        ← Kembali
    </a>
    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <form method="POST" action="{{ route('pricing.store') }}" class="space-y-6 p-6 rounded-2xl border
            ...
            {{-- PRODUCT TYPE --}}
            <div>
                <label class="block text-sm font-medium dark:text-ens-lightest">Tipe Produk</label>
                <select name="product_type" id="product_type" class="mt-1 w-full rounded-xl border-gray-300
                               dark:bg-ens-darkest dark:text-ens-lightest dark:border-ens-darker">
            ...
            {{-- SCOPE --}}
            <div>
                <label class="block text-sm font-medium dark:text-ens-lightest">Berlaku Untuk</label>
                <select name="price_scope" id="price_scope" class="mt-1 w-full rounded-xl border-gray-300 dark:text-ens-lightest
            ...
            <div id="specific-wrapper" class="hidden space-y-4">
                ...
                <div id="course-select" class="hidden">
                    ...
                    <select name="priceable_id" id="course-priceable" class="mt-1 w-full rounded-xl border-gray-300 dark:text-ens-lightest
                                   dark:bg-ens-darkest dark:border-ens-darker">
                ...
                <div id="tryout-select" class="hidden">
                    ...
                    <select name="priceable_id" id="tryout-priceable" class="mt-1 w-full rounded-xl border-gray-300 dark:text-ens-lightest
                                   dark:bg-ens-darkest dark:border-ens-darker">
            ...
            {{-- PRICING TYPE --}}
            <div>
                <label class="block text-sm font-medium dark:text-ens-lightest">Tipe Harga</label>
                <select name="pricing_type" id="pricing_type" class="mt-1 w-full rounded-xl border-gray-300 dark:text-ens-lightest
                               dark:bg-ens-darkest dark:border-ens-darker">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium dark:text-ens-lightest">Minimum Qty</label>
                    <input type="number" name="min_qty" min="1" class="mt-1 w-full rounded-xl border-gray-300 dark:text-ens-lightest
                                  dark:bg-ens-darkest dark:border-ens-darker">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="max_qty" min="1" class="mt-1 w-full rounded-xl border-gray-300 dark:text-ens-lightest
                                  dark:bg-ens-darkest dark:border-ens-darker">
                </div>
            </div>
            ...
            {{-- PRICE --}}
            <div>
                <label class="block text-sm font-medium dark:text-ens-lightest">Harga</label>
                <input type="number" name="price" id="price" min="0" step="0.01" class="mt-1 w-full rounded-xl border-gray-300 dark:text-ens-lightest
                              dark:bg-ens-darkest dark:border-ens-darker">
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <span class="text-sm dark:text-ens-lightest">Aktifkan pricing rule</span>
            </div>

            <div class="pt-4 flex justify-end gap-3">
                <a href="{{ route('pricing.index') }}" class="px-5 py-2.5 rounded-xl border dark:text-ens-lightest">
                    Batal
                </a>
