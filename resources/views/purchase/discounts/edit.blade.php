...
@section('content')
    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <form method="POST" action="{{ route('discounts.update', $discount) }}" class="space-y-6
                     ...
                     bg-white dark:text-ens-lightest dark:bg-ens-darkest">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="name" required value="{{ old('name', $discount->name) }}" class="mt-1 w-full rounded-xl border-gray-300
            ...
            <div>
                ...
                <input type="text" readonly value="{{ $discount->code }}" class="mt-1 w-full rounded-xl bg-gray-100
                            dark:bg-ens-darker border-gray-300">
            ...
            <div>
                ...
                <select name="type" class="mt-1 w-full rounded-xl border-gray-300
                               dark:bg-ens-darkest dark:border-ens-darker">
            ...
            <div>
                ...
                <input type="number" name="value" min="0" required value="{{ old('value', $discount->value) }}" class="mt-1 w-full rounded-xl border-gray-300
                              dark:bg-ens-darkest dark:border-ens-darker">
            ...
            <div>
                ...
                <input type="number" name="max_discount" min="0" value="{{ old('max_discount', $discount->max_discount) }}"
            ...
            <div>
                ...
                <input type="number" name="min_order_amount" min="0"
                    value="{{ old('min_order_amount', $discount->min_order_amount) }}" class="mt-1 w-full rounded-xl border-gray-300
                              dark:bg-ens-darkest dark:border-ens-darker">
            ...
            <div>
                ...
                <input type="number" name="quota" min="1" value="{{ old('quota', $discount->quota) }}" class="mt-1 w-full rounded-xl border-gray-300
                              dark:bg-ens-darkest dark:border-ens-darker">
            ...
            <div>
                ...
                <select name="product_ids[]" id="product-select" multiple
                    class="mt-1 w-full rounded-xl border-gray-300 dark:border-ens-darker">
                    @foreach($products as $product)
                        <option value="{{ $product->id }}" @if(
                            collect(old('product_ids', $discount->targets->pluck('id')))
                                ->contains($product->id)
                        ) selected @endif>
                            {{ $product->name }}
                        </option>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="date" name="starts_at"
                        value="{{ old('starts_at', optional($discount->starts_at)->format('Y-m-d')) }}" class="mt-1 w-full rounded-xl border-gray-300
                                  dark:bg-ens-darkest dark:border-ens-darker">
                ...
                <div>
                    ...
                    <input type="date" name="ends_at"
                        value="{{ old('ends_at', optional($discount->ends_at)->format('Y-m-d')) }}" class="mt-1 w-full rounded-xl border-gray-300
                                  dark:bg-ens-darkest dark:border-ens-darker">
