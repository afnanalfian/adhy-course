...
@section('content')
    ...
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('discounts.edit', $discount) }}" class="px-5 py-2.5 rounded-xl
        ...
        {{-- DETAIL CARD --}}
        <div class="p-6 rounded-2xl border dark:border-ens-darker
                    bg-white dark:bg-ens-darkest space-y-6">
        ...
        {{-- DELETE FORM --}}
        <form method="POST" action="{{ route('discounts.destroy', $discount) }}" class="sweet-confirm"
