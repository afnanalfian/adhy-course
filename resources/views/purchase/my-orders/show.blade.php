...
@section('content')
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <div class="bg-white dark:bg-secondary/60
            ...
            @if ($order->status === 'verified')
                <div class="flex justify-end">
                    <a href="{{ route('orders.invoice', $order) }}" class="inline-flex items-center gap-2
        ...
        @if (
            ...
            <div class="flex justify-end">
                <a href="{{ route('checkout.payment', $order) }}" class="inline-flex items-center justify-center
                            px-6 py-3 rounded-lg
                            bg-primary hover:bg-ens-darker
                            text-white font-medium transition">
