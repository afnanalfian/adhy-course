...
@section('content')
    <div class="max-w-6xl mx-auto space-y-8 px-4 sm:px-0">
        ...
        {{-- Tombol Kembali --}}
        <div class="mb-4">
            <a href="{{ route('orders.index') }}" class="inline-flex items-center gap-2
                        text-sm font-medium
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-secondary/60
                    ...
                    <div class="divide-y divide-slate-200 dark:divide-white/10">
                            ...
                            <div class="px-6 py-4 space-y-2">
                                ...
                                <div class="flex flex-col sm:flex-row sm:justify-between gap-2">
                                    ...
                                    <div class="text-sm sm:text-right">
                                        <div class="font-medium text-slate-800 dark:text-ens-lighter">
                        ...
                        {{-- TOTAL --}}
                        <div class="px-6 py-4 flex justify-between font-semibold dark:text-ens-lightest">
                            <span>Total Dibayar</span>
                            <span class="text-primary dark:text-ens-lightest">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-secondary/60
                    ...
                    <img src="{{ asset('storage/' . $order->payment->proof_image) }}"
                        class="mt-3 rounded-lg border max-w-full" alt="Bukti Pembayaran">
                    @endif
                    @else
                ...
                @if ($order->status === 'paid')
                    <div class="bg-white dark:bg-secondary/60
                        ...
                        <form method="POST" action="{{ route('orders.approve', $order) }}" class="w-full sweet-confirm"
                        ...
                        <form method="POST" action="{{ route('orders.reject', $order) }}" class="w-full sweet-confirm"
                ...
                @if ($order->status === 'verified')
                    <a href="{{ route('orders.invoice', $order) }}" class="inline-flex px-4 py-2 rounded-lg
