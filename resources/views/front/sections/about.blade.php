        ...
        <div class="flex flex-col lg:flex-row items-center lg:items-start gap-12 lg:gap-16">
            ...
            <div class="w-full lg:w-1/2">
                <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                    {{-- Main Image --}}
                    <img src="{{ asset('front/img/about-1.png') }}" alt="Tentang ENS Makassar"
            ...
            <div class="w-full lg:w-1/2">
                <div class="max-w-2xl">
                    {{-- Section Label --}}
                    <span
                        class="inline-block px-4 py-2 bg-primary/10 text-primary text-sm font-semibold rounded-full mb-6">
                        Tentang Kami
                    </span>

                    {{-- Title --}}
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-ens-darkest mb-6 leading-tight">
                    ...
                    <div class="space-y-4 mb-8">
                        <p class="text-secondary text-md leading-relaxed">
                            ENS Makassar adalah platform bimbingan belajar profesional yang berkomitmen untuk
                            memberikan pendidikan berkualitas tinggi dengan metode pengajaran yang inovatif dan efektif.
                        </p>
                        {{-- <p class="text-secondary text-md leading-relaxed">
                            Kami percaya bahwa setiap siswa memiliki potensi unik. Dengan pendekatan personalized
                            learning, kami membantu siswa menemukan cara belajar yang paling sesuai dengan kebutuhan
                            mereka.
                        </p> --}}
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-ens-darkest mb-1">Materi Terupdate</h4>
                                <p class="text-secondary text-sm">Kurikulum sesuai dengan perkembangan terbaru
                                    pendidikan.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-ens-darkest mb-1">Kelas Interaktif</h4>
                                <p class="text-secondary text-sm">Sesi belajar dua arah dengan diskusi aktif dan
                                    interaktif.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-ens-darkest mb-1">Fleksibel Akses</h4>
                                <p class="text-secondary text-sm">Rekaman Pembelajaran tersimpan dan dapat diakses kapan
                                    saja dimana saja.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-ens-darkest mb-1">Practice Everyday</h4>
                    ...
                    {{-- Additional Info
                    <div class="mt-12 pt-8 border-t border-ens-lighter">
