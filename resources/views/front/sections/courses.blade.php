...
<section id="courses" class="scroll-mt-20 py-16 lg:py-20 bg-ens-lightest">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {{-- Section Header --}}
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-ens-darkest mb-4">
        ...
        @if($courses->count() > 0)
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                @foreach($courses as $index => $course)
                    @php
                        ...
                        $isEven = $index % 2 == 0;
                        $bgGradient = $isEven
                            ? 'from-primary/5 to-ens-lighter/30'
                            : 'from-ens-darker/5 to-primary/10';
                    @endphp

                    <div class="course-card relative group">
                        <div
                            class="relative bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border border-ens-lighter/50 h-full flex flex-col">
                            {{-- Thumbnail Section --}}
                            @if($course->thumbnail)
                                <div class="relative h-48 overflow-hidden">
                                    ...
                                    @if($isCourseFree)
                                        <div class="absolute top-4 right-4">
                                            <span
                                                class="px-3 py-1 bg-green-500 text-white text-xs font-bold rounded-full shadow-lg animate-pulse">
                                                GRATIS
                                            </span>
                                        </div>
                                    @endif
                                    <div
                                        class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent h-16">
                                    </div>
                                </div>
                            @else
                                <div
                                    class="relative h-48 bg-gradient-to-r from-primary to-ens-darker flex items-center justify-center">
                                    @if($isCourseFree)
                                        <div class="absolute top-4 right-4">
                                            <span
                                                class="px-3 py-1 bg-green-500 text-white text-xs font-bold rounded-full shadow-lg animate-pulse">
                            ...
                            <div class="flex-1 p-6">
                                ...
                                <div class="mb-4">
                                    <div class="flex items-start justify-between mb-3">
                                        <div class="flex-1">
                                            <h3 class="text-xl font-bold text-ens-darkest mb-2 line-clamp-1">
                                                {{ $course->name }}
                                            </h3>
                                                ...
                                                <div class="flex items-center gap-2 mb-2">
                                                    <div class="flex -space-x-2">
                                                        @foreach($course->teachers->take(2) as $teacher)
                                                            <div
                                                                class="h-7 w-7 rounded-full border-2 border-white bg-ens-lighter flex items-center justify-center overflow-hidden">
                                                                @if($teacher->user->avatar)
                                                                    <img src="{{ Storage::url($teacher->user->avatar) }}"
                                                                        alt="{{ $teacher->user->name }}" class="h-full w-full object-cover">
                                                                @else
                                                        ...
                                                        @if($course->teachers->count() > 2)
                                                            <div
                                                                class="h-7 w-7 rounded-full border-2 border-white bg-primary flex items-center justify-center">
                                ...
                                @if($coursePackage && $coursePackage['description'])
                                    <div class="mb-4 p-3 bg-ens-lightest/50 rounded-lg border border-ens-lighter">
                                        <h4 class="text-xs font-semibold text-ens-darkest mb-1 flex items-center gap-2">
                            ...
                            <div class="p-6 pt-0 mt-auto">
                                <div class="pt-4 border-t border-ens-lighter/50">
                                    {{-- Package Price --}}
                                    @if($isCourseFree)
                                    ...
                                    @elseif($coursePrice > 0)
                                        ...
                                        <div class="mb-4">
                                            <div class="flex items-center justify-between mb-3">
                                                <div>
                                                    <span class="text-sm font-semibold text-ens-darkest">
                                                        Paket Lengkap
                                                    </span>
                                                    <div class="text-xs text-secondary">
                                                        {{ $meetingsCount }} pertemuan
                                            ...
                                            @auth
                                                @if(auth()->user()->hasRole('siswa'))
                                                    <a href="{{ route('browse.index', ['course' => $course->id]) }}"
                                                        class="block w-full px-4 py-2.5 bg-gradient-to-r from-primary to-ens-darker text-white font-medium rounded-lg hover:opacity-90 transition duration-300 text-center">
                                                        Beli Sekarang
                                                    </a>
                                                @endif
                                            @endauth
                                        ...
                                        @if($meetingPricingRules->count() > 0)
                                            <div class="mb-4">
                                                <h4 class="text-xs font-semibold text-ens-darkest mb-2 flex items-center gap-1">
                                                ...
                                                <div class="space-y-1.5">
                                                    @foreach($meetingPricingRules->take(2) as $rule)
                                                        <div
                                                            class="flex justify-between items-center p-2 bg-white border border-ens-lighter rounded-lg text-xs">
                                                            <div>
                                                                @if($rule->min_qty == 1 && $rule->max_qty == 1)
                                                                    <span class="font-medium text-ens-darkest">1 pertemuan</span>
                                                                @elseif($rule->max_qty === null)
                                                                    <span class="font-medium text-ens-darkest">≥ {{ $rule->min_qty }}
                                                                        pertemuan</span>
                                                                @else
                                                                    <span
                                                                        class="font-medium text-ens-darkest">{{ $rule->min_qty }}-{{ $rule->max_qty }}
                                                                        pertemuan</span>
                                                                @endif
                                                            </div>
                                                            <div class="text-right">
                                    ...
                                    @else
                                        ...
                                        <div class="mb-4 p-3 bg-ens-lightest rounded-lg text-center">
                                    ...
                                    @if($allCourseMeetings->count() > 0)
                                        <button
                                            class="view-meetings-btn w-full px-4 py-2 border border-primary/30 text-primary font-medium rounded-lg hover:bg-primary hover:text-white transition duration-300 text-sm"
                                            data-course-id="{{ $course->id }}" data-course-name="{{ $course->name }}"
                                            data-course-price="{{ $coursePrice }}" data-is-free="{{ $isCourseFree ? '1' : '0' }}"
                            ...
                            {{-- Decorative Corner --}}
                            <div class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl {{ $bgGradient }} rounded-bl-full">
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                @if($tryouts->count() > 0)
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                        @foreach($tryouts as $tryout)
                            ...
                            <div
                                class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-ens-lighter/50 overflow-hidden">
                                <div class="p-5">
                                    {{-- Tryout Header --}}
                                    <div class="mb-4">
                                        <h3 class="text-lg font-bold text-ens-darkest mb-2 line-clamp-2">
                                            {{ $tryout->title }}
                                        </h3>
                                    ...
                                    <div class="pt-4 border-t border-ens-lighter/50">
                                        <div class="flex items-center justify-between mb-4">
                                            <div>
                                                <span class="text-sm font-semibold text-ens-darkest">Harga Tryout</span>
                                            </div>
                                            <div class="text-right">
                                                @if($price > 0)
                                        ...
                                        <a href="{{ route('browse.index', ['tryout' => $tryout->id]) }}"
                                            class="block w-full px-4 py-2.5 bg-gradient-to-r from-primary to-ens-darker text-white font-medium rounded-lg hover:opacity-90 transition duration-300 text-center text-sm">
                                            Daftar Sekarang
                                        </a>
                                    </div>
                                </div>
                ...
                @else
                    ...
                    <div class="text-center py-10">
                        <div
                            class="inline-flex items-center justify-center h-16 w-16 rounded-full bg-ens-lighter text-primary mb-4">
            ...
            <div class="bg-gradient-to-r from-ens-darker/5 to-primary/10 rounded-2xl p-8 lg:p-12 mb-16">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="text-center">
                        ...
                        <h4 class="text-lg font-bold text-ens-darkest mb-2">Materi Terstruktur</h4>
                    ...
                    <div class="text-center">
                        ...
                        <h4 class="text-lg font-bold text-ens-darkest mb-2">Tentor Profesional</h4>
                    ...
                    <div class="text-center">
                        ...
                        <h4 class="text-lg font-bold text-ens-darkest mb-2">Fleksibel</h4>
        ...
        @else
            ...
            <div class="text-center py-16">
                <div
                    class="inline-flex items-center justify-center h-24 w-24 rounded-full bg-gradient-to-r from-primary/10 to-ens-darker/10 text-primary mb-6">
                ...
                <h3 class="text-2xl font-bold text-ens-darkest mb-3">
...
<div id="meetingsModal" class="fixed inset-0 z-[60] overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog"
    aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        {{-- Background overlay --}}
        <div class="fixed inset-0 bg-ens-darkest/90 backdrop-blur-sm transition-opacity" aria-hidden="true"></div>
        ...
        <div
            ...
            {{-- Modal Header --}}
            <div class="bg-gradient-to-r from-primary/10 to-ens-darker/5 px-6 py-4">
                <div class="flex justify-between items-center">
                    <div>
                        <h3 id="modalCourseName" class="text-2xl font-bold text-ens-darkest"></h3>
                    ...
                    <button type="button" id="closeModal"
                        class="text-ens-darkest hover:text-primary p-2 rounded-lg hover:bg-ens-lightest transition">
            ...
            <div class="px-6 pt-6 pb-4">
                ...
                <div id="modalPricingRules" class="mb-8 p-4 bg-ens-lightest rounded-xl border border-ens-lighter"></div>
            ...
            {{-- Modal Footer --}}
            <div class="bg-ens-lightest px-6 py-4 border-t border-ens-lighter">
                <div class="flex flex-col sm:flex-row gap-3 justify-end">
                    @auth
                        @if(auth()->user()->hasRole('siswa'))
                            <button type="button" id="modalBuyPackage"
                                class="px-6 py-3 bg-gradient-to-r from-primary to-ens-darker text-white font-medium rounded-lg hover:opacity-90 transition duration-300">
                                Beli Paket Lengkap
                            </button>
                        @endif
                    @endauth
                    ...
                    <button type="button" id="modalClose"
                        class="px-6 py-3 border border-ens-lighter bg-white text-ens-darkest font-medium rounded-lg hover:bg-ens-lightest transition duration-300">
                        Tutup
                    </button>
                </div>
            </div>
                    ...
                    if (data.success && data.meetings.length > 0) {
                        ...
                        `;
                            if (modalBuyPackage) {
                                ...
                                modalBuyPackage.className = modalBuyPackage.className.replace('from-primary to-ens-darker', 'from-green-500 to-green-600');
                            }
                        ...
                        `;
                            if (modalBuyPackage) {
                                ...
                                modalBuyPackage.className = modalBuyPackage.className.replace('from-green-500 to-green-600', 'from-primary to-ens-darker');
                            }
                        } else {
                        ...
                        if (!isFree && meetingRules.length > 0) {
                            ...
                            <h4 class="text-sm font-semibold text-ens-darkest mb-3 flex items-center gap-2">
                        ...
                        `;
                            ...
                            meetingRules.forEach(rule => {
                                ...
                                pricingRulesHtml += `
                                <div class="bg-white p-3 rounded-lg border border-ens-lighter text-center">
                        ...
                        Object.entries(meetingsByMonth).forEach(([monthYear, monthMeetings]) => {
                            ...
                            <h4 class="text-lg font-bold text-ens-darkest mb-2 flex items-center gap-2">
                        ...
                        `;
                            ...
                            monthMeetings.forEach((meeting, index) => {
                                ...
                                meetingElement.className = 'p-4 bg-white border border-ens-lighter rounded-xl mb-3 hover:border-primary/30 transition-colors';
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex-1">
                                        <h5 class="font-semibold text-ens-darkest mb-1">${meeting.title}</h5>
                                        <div class="flex items-center gap-2 text-sm text-secondary">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                            </svg>
                                            <span>${meeting.scheduled_at_formatted}</span>
                                            <span class="px-2 py-0.5 text-xs rounded-full bg-ens-lighter text-ens-darkest">
