...
<title>@yield('title', 'ENS Makassar – Bimbel Online, Quiz Harian, & Tryout')</title>
...
<meta property="og:title" content="@yield('title', 'ENS Makassar – Bimbel Online, Quiz Harian, & Tryout')">
<meta property="og:description" content="@yield('description', 'Bimbel online, tryout beragam, quiz harian, live zoom, materi lengkap, latihan soal terbaru.')">
<meta property="og:type" content="website">
<meta property="og:url" content="{{ url()->current() }}">
<meta property="og:image" content="{{ asset('img/og-image.jpg') }}">

<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="@yield('title', 'ENS Makassar – Bimbel Online, Quiz Harian, & Tryout')">
