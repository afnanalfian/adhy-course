...
<body class="h-screen overflow-hidden flex flex-col
         bg-gradient-to-br from-ens-lighter via-white to-ens-light/30
    ...
    {{-- Navbar --}}
    <nav class="w-full
                bg-ens-lightest dark:bg-ens-darkest/80
                backdrop-blur
                border-b border-ens-light/30
                shadow-sm py-4
                sticky top-0 z-50">
        <div class="container mx-auto px-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                " class="text-ens-darkest dark:text-ens-lighter hover:scale-110 transition">

                    <!-- Moon (light mode) -->
                    <svg class="block dark:hidden" width="24" height="24" fill="none" stroke="currentColor"
                        stroke-width="2">
                        <path d="M21 12.79A9 9 0 1 1 11.21 3a7 7 0 0 0 9.79 9.79Z" />
                    </svg>

                    <!-- Sun (dark mode) -->
                    <svg class="hidden dark:block" width="24" height="24" fill="none" stroke="currentColor"
                        stroke-width="2">
                ...
                <a href="{{ route('login') }}" class="text-sm font-medium rounded-xl transition
    ...
    : 'text-gray-700 dark:text-gray-300 hover:text-primary' }}">
                ...
                <a href="{{ route('register') }}" class="text-sm font-medium rounded-xl transition
